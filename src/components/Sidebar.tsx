...
export function Sidebar() {
    ...
    return (
      <>
        ...
        <Button
          variant="ghost"
          size="sm"
          className="fixed top-4 left-4 z-50 h-10 w-10 p-0 bg-card/95 backdrop-blur-sm border border-border/50 shadow-lg hover:bg-card md:hidden"
  ...
  return (
    <div className={cn(
      "hidden md:flex h-screen flex-col transition-all duration-500 ease-out relative",
