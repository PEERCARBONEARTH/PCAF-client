      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-border bg-gradient-to-r from-muted/50 to-card backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-foreground transition-colors duration-300">
                PeerCarbon
              </h1>
...
export function FinancedEmissionsLayout({ children }: FinancedEmissionsLayoutProps) {
  return (
    <OnboardingProvider>
      <FinancedEmissionsLayoutContent>{children}</FinancedEmissionsLayoutContent>
    </OnboardingProvider>
  );
}
